...
{
    Lance primeiroLance(Usuario("Felipe Azevedo"), 500);
    Lance segundoLance(Usuario("Angela Maria"), 20520);
...
{
    Lance primeiroLance(Usuario("Wagner Rabelo"), 2000);
    Lance segundoLance(Usuario("Fabiana Bolicardo"), 1000);
    Leilao leilao("Fiat 147 0Km");
    leilao.recebeLance(primeiroLance);
    leilao.recebeLance(segundoLance);
...
TEST_CASE("Avaliador") {
    ...
    SECTION("Deve recuperar os 3 maiores lances") {
        // Arrange - Given
        Lance primeiroLance(Usuario("Tales de Mileto"), 1000);
        Lance segundoLance(Usuario("Ana Maria Braga"), 2000);
